<div class="basket-summary__container js-basket-container wrapper">
        ...
        <div class="basket-summary__breakdown basket">
            ...
            <a href="#" class="basket-summary__included-btn js-basket-desktop-trigger">
            <span class="underline">What's included</span> <?php svg('arrow-down-bold', 12, 12, 'basket-summary__included-icon', ''); ?></a>
